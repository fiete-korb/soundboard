...
-- HeidiSQL version:             7.0.0.4133
-- Date/time:                    2012-10-26 13:11:44
-- --------------------------------------------------------
...
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
	...
	(NULL, 'sound', 'countries', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'sound', 'countries', 'country', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin2', 'latin2_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'dialing_code', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'sound', 'dialing_code', 'iso2', 2, NULL, 'NO', 'char', 2, 6, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(2)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'dialing_code', 'name', 3, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'dialing_code', 'dialing_code', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(4)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'site_settings', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'sound', 'site_settings', 'site_url', 2, NULL, 'NO', 'varchar', 85, 85, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(85)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'site_settings', 'site_email', 3, NULL, 'NO', 'varchar', 85, 85, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(85)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'sound_categories', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'sound', 'sound_categories', 'name', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'soundfiles', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'sound', 'soundfiles', 'display_name', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'soundfiles', 'file_name', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'soundfiles', 'cat', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(8)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'username', 2, NULL, 'NO', 'varchar', 8, 8, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(8)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'password', 3, NULL, 'NO', 'varchar', 32, 32, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'temp_pass', 4, NULL, 'NO', 'varchar', 32, 32, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'temp_pass_active', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'first_name', 6, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'last_name', 7, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'email', 8, NULL, 'NO', 'varchar', 35, 35, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(35)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'dialing_code', 9, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'phone', 10, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(25)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'city', 11, NULL, 'NO', 'varchar', 80, 80, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'country', 12, NULL, 'NO', 'varchar', 80, 80, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'thumb_path', 13, NULL, 'NO', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'img_path', 14, NULL, 'NO', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'active', 15, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'level_access', 16, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'reg_date', 17, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
	(NULL, 'sound', 'users', 'last_active', 18, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', '');
...
INSERT INTO `GLOBAL_STATUS` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('BINLOG_CACHE_USE', '0'),
	('BYTES_RECEIVED', '124826'),
	('BYTES_SENT', '563520'),
	('COM_ADMIN_COMMANDS', '197'),
	...
	('HANDLER_DISCOVER', '0'),
	('HANDLER_PREPARE', '0'),
	('HANDLER_READ_FIRST', '82'),
	('HANDLER_READ_KEY', '108'),
	('HANDLER_READ_NEXT', '239'),
	('HANDLER_READ_PREV', '0'),
	('HANDLER_READ_RND', '12'),
	('HANDLER_READ_RND_NEXT', '6047'),
	('HANDLER_ROLLBACK', '0'),
	('HANDLER_SAVEPOINT', '0'),
	...
	('INNODB_BUFFER_POOL_PAGES_FLUSHED', '9'),
	('INNODB_BUFFER_POOL_PAGES_FREE', '486'),
	('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
	('INNODB_BUFFER_POOL_PAGES_TOTAL', '512'),
	('INNODB_BUFFER_POOL_READ_AHEAD_RND', '1'),
	('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
	('INNODB_BUFFER_POOL_READ_REQUESTS', '6379'),
	('INNODB_BUFFER_POOL_READS', '18'),
	('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
	('INNODB_BUFFER_POOL_WRITE_REQUESTS', '15'),
	...
	('INNODB_DATA_WRITES', '24'),
	('INNODB_DATA_WRITTEN', '301056'),
	('INNODB_DBLWR_PAGES_WRITTEN', '9'),
	...
	('QCACHE_FREE_MEMORY', '16748688'),
	('QCACHE_HITS', '287'),
	('QCACHE_INSERTS', '68'),
	('QCACHE_LOWMEM_PRUNES', '0'),
	('QCACHE_NOT_CACHED', '98'),
	...
	('THREADS_RUNNING', '1'),
	('UPTIME', '3193042'),
	('UPTIME_SINCE_FLUSH_STATUS', '3193042');
...
INSERT INTO `KEY_COLUMN_USAGE` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `POSITION_IN_UNIQUE_CONSTRAINT`, `REFERENCED_TABLE_SCHEMA`, `REFERENCED_TABLE_NAME`, `REFERENCED_COLUMN_NAME`) VALUES
	...
	(NULL, 'sound', 'PRIMARY', NULL, 'sound', 'countries', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'sound', 'PRIMARY', NULL, 'sound', 'dialing_code', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'sound', 'PRIMARY', NULL, 'sound', 'site_settings', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'sound', 'PRIMARY', NULL, 'sound', 'sound_categories', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'sound', 'PRIMARY', NULL, 'sound', 'soundfiles', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'sound', 'FK_soundfiles_sound_categories', NULL, 'sound', 'soundfiles', 'cat', 1, 1, 'sound', 'sound_categories', 'id'),
	(NULL, 'sound', 'PRIMARY', NULL, 'sound', 'users', 'id', 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `PARTITIONS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `PARTITION_NAME`, `SUBPARTITION_NAME`, `PARTITION_ORDINAL_POSITION`, `SUBPARTITION_ORDINAL_POSITION`, `PARTITION_METHOD`, `SUBPARTITION_METHOD`, `PARTITION_EXPRESSION`, `SUBPARTITION_EXPRESSION`, `PARTITION_DESCRIPTION`, `TABLE_ROWS`, `AVG_ROW_LENGTH`, `DATA_LENGTH`, `MAX_DATA_LENGTH`, `INDEX_LENGTH`, `DATA_FREE`, `CREATE_TIME`, `UPDATE_TIME`, `CHECK_TIME`, `CHECKSUM`, `PARTITION_COMMENT`, `NODEGROUP`, `TABLESPACE_NAME`) VALUES
	(NULL, 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-26 13:11:35', '2012-10-26 13:11:35', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-26 13:11:35', '2012-10-26 13:11:35', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-26 13:11:35', '2012-10-26 13:11:35', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-26 13:11:35', '2012-10-26 13:11:35', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-26 13:11:35', '2012-10-26 13:11:35', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-26 13:11:35', '2012-10-26 13:11:35', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2679, 0, 16770540, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3545, 0, 16743035, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-26 13:11:35', '2012-10-26 13:11:35', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2012-10-26 13:11:35', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-26 13:11:35', '2012-10-26 13:11:35', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2012-06-29 12:03:41', '2012-06-29 12:03:41', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 123848989752688639, 2048, 0, '2012-06-29 12:03:42', '2012-06-29 12:03:42', '2012-06-29 12:03:42', NULL, '', '', NULL),
	(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-29 12:03:42', '2012-06-29 12:03:42', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2012-06-29 12:03:41', '2012-06-29 12:03:41', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2012-06-29 12:03:10', '2012-06-29 12:03:11', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 451, 197, 88847, 55450570411999231, 16384, 0, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 991, 9, 8919, 2533274790395903, 17408, 0, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 507, 873, 443088, 281474976710655, 20480, 0, '2012-06-29 12:03:10', '2012-06-29 12:03:11', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2012-06-29 12:03:42', '2012-06-29 12:03:42', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2012-06-29 12:03:10', '2012-06-29 12:03:10', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-29 12:03:42', '2012-06-29 12:03:42', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2012-06-29 12:03:42', '2012-06-29 12:03:42', '2012-06-29 12:03:42', NULL, '', '', NULL),
	(NULL, 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2012-06-29 12:03:10', '2012-06-29 12:03:10', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2012-06-29 12:03:41', '2012-06-29 12:03:41', '2012-06-29 12:03:41', NULL, '', '', NULL),
	(NULL, 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 94, 472, 281474976710655, 2048, 0, '2012-06-29 12:03:42', '2012-07-12 18:16:59', NULL, NULL, '', '', NULL),
	(NULL, 'sound', 'countries', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 215, 22, 4756, 281474976710655, 5120, 0, '2012-07-12 17:26:22', '2012-07-12 17:26:22', NULL, NULL, '', '', NULL),
	(NULL, 'sound', 'dialing_code', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 246, 28, 6960, 281474976710655, 5120, 0, '2012-07-12 17:26:22', '2012-07-12 17:26:22', NULL, NULL, '', '', NULL),
	(NULL, 'sound', 'site_settings', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 44, 44, 281474976710655, 2048, 0, '2012-07-12 17:26:22', '2012-07-12 17:26:22', NULL, NULL, '', '', NULL),
	(NULL, 'sound', 'sound_categories', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, 1365, 16384, NULL, 0, 4194304, '2012-08-20 11:17:17', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'sound', 'soundfiles', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 81, 202, 16384, NULL, 16384, 4194304, '2012-08-20 11:24:27', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'sound', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 133, 1168, 281474976710655, 2048, 636, '2012-07-12 17:28:28', '2012-07-16 12:03:58', '2012-08-24 17:08:46', NULL, '', '', NULL);
...
INSERT INTO `PROCESSLIST` (`ID`, `USER`, `HOST`, `DB`, `COMMAND`, `TIME`, `STATE`, `INFO`) VALUES
	(930, 'root', '192.168.0.150:40503', 'sound', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST` LIMIT 0, 104857600');
...
INSERT INTO `REFERENTIAL_CONSTRAINTS` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `UNIQUE_CONSTRAINT_CATALOG`, `UNIQUE_CONSTRAINT_SCHEMA`, `UNIQUE_CONSTRAINT_NAME`, `MATCH_OPTION`, `UPDATE_RULE`, `DELETE_RULE`, `TABLE_NAME`, `REFERENCED_TABLE_NAME`) VALUES
	(NULL, 'sound', 'FK_soundfiles_sound_categories', NULL, 'sound', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'soundfiles', 'sound_categories');
...
INSERT INTO `SCHEMATA` (`CATALOG_NAME`, `SCHEMA_NAME`, `DEFAULT_CHARACTER_SET_NAME`, `DEFAULT_COLLATION_NAME`, `SQL_PATH`) VALUES
	...
	(NULL, 'sound', 'latin1', 'latin1_swedish_ci', NULL);
...
INSERT INTO `SESSION_STATUS` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('INNODB_BUFFER_POOL_READ_AHEAD_RND', '1'),
	('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
	('INNODB_BUFFER_POOL_READ_REQUESTS', '6442'),
	('INNODB_BUFFER_POOL_READS', '18'),
	('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
	('INNODB_BUFFER_POOL_WRITE_REQUESTS', '15'),
	('INNODB_DATA_FSYNCS', '19'),
	...
	('THREADS_RUNNING', '1'),
	('UPTIME', '3193043'),
	('UPTIME_SINCE_FLUSH_STATUS', '3193043');
...
INSERT INTO `STATISTICS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `NON_UNIQUE`, `INDEX_SCHEMA`, `INDEX_NAME`, `SEQ_IN_INDEX`, `COLUMN_NAME`, `COLLATION`, `CARDINALITY`, `SUB_PART`, `PACKED`, `NULLABLE`, `INDEX_TYPE`, `COMMENT`) VALUES
	...
	(NULL, 'mysql', 'help_keyword', 0, 'mysql', 'PRIMARY', 1, 'help_keyword_id', 'A', 451, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'mysql', 'help_keyword', 0, 'mysql', 'name', 1, 'name', 'A', 451, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'mysql', 'help_relation', 0, 'mysql', 'PRIMARY', 1, 'help_keyword_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'mysql', 'help_relation', 0, 'mysql', 'PRIMARY', 2, 'help_topic_id', 'A', 991, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'mysql', 'help_topic', 0, 'mysql', 'PRIMARY', 1, 'help_topic_id', 'A', 507, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'mysql', 'help_topic', 0, 'mysql', 'name', 1, 'name', 'A', 507, NULL, NULL, '', 'BTREE', ''),
	...
	(NULL, 'sound', 'countries', 0, 'sound', 'PRIMARY', 1, 'id', 'A', 215, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'sound', 'dialing_code', 0, 'sound', 'PRIMARY', 1, 'id', 'A', 246, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'sound', 'site_settings', 0, 'sound', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'sound', 'sound_categories', 0, 'sound', 'PRIMARY', 1, 'id', 'A', 12, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'sound', 'soundfiles', 0, 'sound', 'PRIMARY', 1, 'id', 'A', 81, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'sound', 'soundfiles', 1, 'sound', 'FK_soundfiles_sound_categories', 1, 'cat', 'A', 27, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'sound', 'users', 0, 'sound', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '');
...
INSERT INTO `TABLES` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `TABLE_TYPE`, `ENGINE`, `VERSION`, `ROW_FORMAT`, `TABLE_ROWS`, `AVG_ROW_LENGTH`, `DATA_LENGTH`, `MAX_DATA_LENGTH`, `INDEX_LENGTH`, `DATA_FREE`, `AUTO_INCREMENT`, `CREATE_TIME`, `UPDATE_TIME`, `CHECK_TIME`, `TABLE_COLLATION`, `CHECKSUM`, `CREATE_OPTIONS`, `TABLE_COMMENT`) VALUES
	(NULL, 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
	(NULL, 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
	(NULL, 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
	(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-26 13:11:36', '2012-10-26 13:11:36', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', ''),
	(NULL, 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
	(NULL, 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
	(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-26 13:11:36', '2012-10-26 13:11:36', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
	(NULL, 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
	(NULL, 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	(NULL, 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	(NULL, 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
	(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-26 13:11:36', '2012-10-26 13:11:36', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', ''),
	(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-26 13:11:36', '2012-10-26 13:11:36', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', ''),
	(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-26 13:11:36', '2012-10-26 13:11:36', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
	(NULL, 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
	(NULL, 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
	(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-26 13:11:36', '2012-10-26 13:11:36', NULL, 'utf8_general_ci', NULL, 'max_rows=588', ''),
	(NULL, 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
	(NULL, 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
	(NULL, 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	(NULL, 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	(NULL, 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2679, 0, 16770540, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6262', ''),
	(NULL, 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3545, 0, 16743035, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4732', ''),
	(NULL, 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
	(NULL, 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
	(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-26 13:11:36', '2012-10-26 13:11:36', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
	(NULL, 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2012-10-26 13:11:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
	(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-26 13:11:36', '2012-10-26 13:11:36', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', ''),
	(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2012-06-29 12:03:41', '2012-06-29 12:03:41', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
	(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 123848989752688639, 2048, 0, NULL, '2012-06-29 12:03:42', '2012-06-29 12:03:42', '2012-06-29 12:03:42', 'utf8_bin', NULL, '', 'Database privileges'),
	(NULL, 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-29 12:03:42', '2012-06-29 12:03:42', NULL, 'utf8_general_ci', NULL, '', 'Events'),
	(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2012-06-29 12:03:41', '2012-06-29 12:03:41', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
	(NULL, 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
	(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2012-06-29 12:03:10', '2012-06-29 12:03:11', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
	(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 451, 197, 88847, 55450570411999231, 16384, 0, NULL, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
	(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 991, 9, 8919, 2533274790395903, 17408, 0, NULL, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
	(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 507, 873, 443088, 281474976710655, 20480, 0, NULL, '2012-06-29 12:03:10', '2012-06-29 12:03:11', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
	(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2012-06-29 12:03:42', '2012-06-29 12:03:42', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
	(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, 'latin1_swedish_ci', NULL, '', ''),
	(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2012-06-29 12:03:10', '2012-06-29 12:03:10', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
	(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-29 12:03:42', '2012-06-29 12:03:42', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
	(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2012-06-29 12:03:42', '2012-06-29 12:03:42', '2012-06-29 12:03:42', 'utf8_bin', NULL, '', 'Procedure privileges'),
	(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2012-06-29 12:03:10', '2012-06-29 12:03:10', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
	(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
	(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2012-06-29 12:03:41', '2012-06-29 12:03:41', '2012-06-29 12:03:41', 'utf8_bin', NULL, '', 'Table privileges'),
	(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
	(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
	(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
	(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
	(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2012-06-29 12:03:11', '2012-06-29 12:03:11', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
	(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 94, 472, 281474976710655, 2048, 0, NULL, '2012-06-29 12:03:42', '2012-07-12 18:16:59', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
	(NULL, 'sound', 'countries', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 215, 22, 4756, 281474976710655, 5120, 0, 221, '2012-07-12 17:26:22', '2012-07-12 17:26:22', NULL, 'latin2_general_ci', NULL, '', ''),
	(NULL, 'sound', 'dialing_code', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 246, 28, 6960, 281474976710655, 5120, 0, 247, '2012-07-12 17:26:22', '2012-07-12 17:26:22', NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'sound', 'site_settings', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 44, 44, 281474976710655, 2048, 0, 2, '2012-07-12 17:26:22', '2012-07-12 17:26:22', NULL, 'latin1_swedish_ci', NULL, '', ''),
	(NULL, 'sound', 'sound_categories', 'BASE TABLE', 'InnoDB', 10, 'Compact', 12, 1365, 16384, 0, 0, 4194304, 13, '2012-08-20 11:17:17', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
	(NULL, 'sound', 'soundfiles', 'BASE TABLE', 'InnoDB', 10, 'Compact', 81, 202, 16384, 0, 16384, 4194304, 82, '2012-08-20 11:24:27', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
	(NULL, 'sound', 'users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 133, 1168, 281474976710655, 2048, 636, 16, '2012-07-12 17:28:28', '2012-07-16 12:03:58', '2012-08-24 17:08:46', 'latin1_swedish_ci', NULL, '', '');
...
INSERT INTO `TABLE_CONSTRAINTS` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `TABLE_SCHEMA`, `TABLE_NAME`, `CONSTRAINT_TYPE`) VALUES
	...
	(NULL, 'sound', 'PRIMARY', 'sound', 'countries', 'PRIMARY KEY'),
	(NULL, 'sound', 'PRIMARY', 'sound', 'dialing_code', 'PRIMARY KEY'),
	(NULL, 'sound', 'PRIMARY', 'sound', 'site_settings', 'PRIMARY KEY'),
	(NULL, 'sound', 'PRIMARY', 'sound', 'sound_categories', 'PRIMARY KEY'),
	(NULL, 'sound', 'PRIMARY', 'sound', 'soundfiles', 'PRIMARY KEY'),
	(NULL, 'sound', 'FK_soundfiles_sound_categories', 'sound', 'soundfiles', 'FOREIGN KEY'),
	(NULL, 'sound', 'PRIMARY', 'sound', 'users', 'PRIMARY KEY');
...
INSERT INTO `USER_PRIVILEGES` (`GRANTEE`, `TABLE_CATALOG`, `PRIVILEGE_TYPE`, `IS_GRANTABLE`) VALUES
	...
	('\'root\'@\'johnny\'', NULL, 'SELECT', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'INSERT', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'UPDATE', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'DELETE', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'CREATE', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'DROP', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'RELOAD', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'SHUTDOWN', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'PROCESS', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'FILE', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'REFERENCES', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'INDEX', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'ALTER', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'SHOW DATABASES', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'SUPER', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'CREATE TEMPORARY TABLES', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'LOCK TABLES', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'EXECUTE', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'REPLICATION SLAVE', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'REPLICATION CLIENT', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'CREATE VIEW', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'SHOW VIEW', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'CREATE ROUTINE', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'ALTER ROUTINE', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'CREATE USER', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'EVENT', 'YES'),
	('\'root\'@\'johnny\'', NULL, 'TRIGGER', 'YES'),
	...
	('\'root\'@\'192.168.0.120\'', NULL, 'SELECT', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'INSERT', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'UPDATE', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'DELETE', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'CREATE', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'DROP', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'RELOAD', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'SHUTDOWN', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'PROCESS', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'FILE', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'REFERENCES', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'INDEX', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'ALTER', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'SHOW DATABASES', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'SUPER', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'CREATE TEMPORARY TABLES', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'LOCK TABLES', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'EXECUTE', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'REPLICATION SLAVE', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'REPLICATION CLIENT', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'CREATE VIEW', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'SHOW VIEW', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'CREATE ROUTINE', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'ALTER ROUTINE', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'CREATE USER', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'EVENT', 'YES'),
	('\'root\'@\'192.168.0.120\'', NULL, 'TRIGGER', 'YES'),
...
-- Dumping data for table mysql.help_keyword: 451 rows
...
INSERT INTO `help_keyword` (`help_keyword_id`, `name`) VALUES
	...
	(259, 'CODE'),
	(260, 'CURSOR'),
	(261, 'GEOMETRYCOLLECTIONFROMTEXT'),
	(262, 'CHAIN'),
	(263, 'LOGFILE'),
	(264, 'FLUSH'),
	(265, 'CREATE'),
	...
	(333, 'SQL_THREAD'),
	(334, 'SERVER'),
	(335, 'MAX_QUERIES_PER_HOUR'),
	(336, 'MASTER_SSL_CERT'),
	(337, 'MULTIPOLYGONFROMWKB'),
	(338, 'TRANSACTION'),
	(339, 'DAY_MINUTE'),
	(340, 'STDDEV'),
	(341, 'DATE_SUB'),
...
-- Dumping data for table mysql.help_relation: 991 rows
...
-- Dumping data for table mysql.help_topic: 507 rows
...
INSERT INTO `help_topic` (`help_topic_id`, `name`, `help_category_id`, `description`, `example`, `url`) VALUES
	...
	(4, 'CONTAINS', 30, 'Contains(g1,g2)\n\nReturns 1 or 0 to indicate whether g1 completely contains g2. This\ntests the opposite relationship as Within().\n\nURL: http://dev.mysql.com/doc/refman/5.1/en/functions-for-testing-spatial-relations-between-geometric-objects.html#functions-that-test-spatial-relationships-between-geometries\n\n', '', 'http://dev.mysql.com/doc/refman/5.1/en/functions-for-testing-spatial-relations-between-geometric-objects.html#functions-that-tes'),
	...
	(187, 'MBREQUAL', 6, 'MBREqual(g1,g2)\n\nReturns 1 or 0 to indicate whether the Minimum Bounding Rectangles of\nthe two geometries g1 and g2 are the same.\n\nURL: http://dev.mysql.com/doc/refman/5.1/en/functions-for-testing-spatial-relations-between-geometric-objects.html#relations-on-geometry-mbr\n\n', '', 'http://dev.mysql.com/doc/refman/5.1/en/functions-for-testing-spatial-relations-between-geometric-objects.html#relations-on-geome'),
	(188, 'TIMESTAMP FUNCTION', 31, 'Syntax:\nTIMESTAMP(expr), TIMESTAMP(expr1,expr2)\n\nWith a single argument, this function returns the date or datetime\nexpression expr as a datetime value. With two arguments, it adds the\ntime expression expr2 to the date or datetime expression expr1 and\nreturns the result as a datetime value.\n\nURL: http://dev.mysql.com/doc/refman/5.1/en/date-and-time-functions.html\n\n', 'mysql> SELECT TIMESTAMP(\'2003-12-31\');\n        -> \'2003-12-31 00:00:00\'\nmysql> SELECT TIMESTAMP(\'2003-12-31 12:00:00\',\'12:00:00\');\n        -> \'2004-01-01 00:00:00\'\n', 'http://dev.mysql.com/doc/refman/5.1/en/date-and-time-functions.html'),
	(189, 'HELP_VERSION', 9, 'This help information was generated from the MySQL 5.1 Reference Manual\non: 2012-04-15 (revision: 30082)\n\nThis information applies to MySQL 5.1 through 5.1.64.\n', '', ''),
...
-- Dumping data for table mysql.proc: 0 rows
...
INSERT INTO `user` (`Host`, `User`, `Password`, `Select_priv`, `Insert_priv`, `Update_priv`, `Delete_priv`, `Create_priv`, `Drop_priv`, `Reload_priv`, `Shutdown_priv`, `Process_priv`, `File_priv`, `Grant_priv`, `References_priv`, `Index_priv`, `Alter_priv`, `Show_db_priv`, `Super_priv`, `Create_tmp_table_priv`, `Lock_tables_priv`, `Execute_priv`, `Repl_slave_priv`, `Repl_client_priv`, `Create_view_priv`, `Show_view_priv`, `Create_routine_priv`, `Alter_routine_priv`, `Create_user_priv`, `Event_priv`, `Trigger_priv`, `ssl_type`, `ssl_cipher`, `x509_issuer`, `x509_subject`, `max_questions`, `max_updates`, `max_connections`, `max_user_connections`) VALUES
	('localhost', 'root', '*49D3CEBD189B8C5D4A47C975133BB2357A327585', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
	('johnny', 'root', '*49D3CEBD189B8C5D4A47C975133BB2357A327585', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
	('%', 'root', '*49D3CEBD189B8C5D4A47C975133BB2357A327585', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
	('localhost', 'debian-sys-maint', '*7D5A6A34CEACF11C832539A1400CE3903F022614', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
	('192.168.0.120', 'root', '*49D3CEBD189B8C5D4A47C975133BB2357A327585', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0);
/*!40000 ALTER TABLE `user` ENABLE KEYS */;


-- Dumping database structure for sound
DROP DATABASE IF EXISTS `sound`;
CREATE DATABASE IF NOT EXISTS `sound` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `sound`;


-- Dumping structure for table sound.countries
CREATE TABLE IF NOT EXISTS `countries` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `country` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=221 DEFAULT CHARSET=latin2;

-- Dumping data for table sound.countries: 215 rows
...
-- Dumping structure for table sound.dialing_code
...
-- Dumping data for table sound.dialing_code: 246 rows
/*!40000 ALTER TABLE `dialing_code` DISABLE KEYS */;
INSERT INTO `dialing_code` (`id`, `iso2`, `name`, `dialing_code`) VALUES
	...
	(245, 'ZM', 'Zambia', 260),
	(246, 'ZW', 'Zimbabwe', 263);
/*!40000 ALTER TABLE `dialing_code` ENABLE KEYS */;


-- Dumping structure for table sound.site_settings
...
-- Dumping data for table sound.site_settings: 1 rows
...
-- Dumping structure for table sound.soundfiles
CREATE TABLE IF NOT EXISTS `soundfiles` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `display_name` text NOT NULL,
  `file_name` text NOT NULL,
  `cat` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_soundfiles_sound_categories` (`cat`),
  CONSTRAINT `FK_soundfiles_sound_categories` FOREIGN KEY (`cat`) REFERENCES `sound_categories` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=latin1;

-- Dumping data for table sound.soundfiles: ~81 rows (approximately)
/*!40000 ALTER TABLE `soundfiles` DISABLE KEYS */;
INSERT INTO `soundfiles` (`id`, `display_name`, `file_name`, `cat`) VALUES
	(1, 'Jeopardy', 'jeopardy_theme.ogg', 2),
	(2, 'Star Trek red alert', 'red_alert.ogg', 2),
	(3, 'Darth Vader', 'imperial_march.ogg', 2),
	(4, 'Zonk', 'zonk.ogg', 2),
	(5, 'HA HA', 'nelson.ogg', 11),
	(6, 'Ruhe im Puff', 'stromberg_ruhe.ogg', 2),
	(7, 'Schwazzen Bildschirm', 'schwazzen_bildschirm.ogg', 11),
	(8, 'Screw you guys', 'screw_you_guys.ogg', 11),
	(9, 'I have made fire', 'made_fire.ogg', 2),
	(10, 'On Off', 'on_off.ogg', 2),
	(11, 'Scheissding', 'scheissding.ogg', 11),
	(12, 'Wunderbar', 'wunderbar.ogg', 2),
	(13, 'Bazinga', 'bazinga.ogg', 2),
	(14, 'Halt Stop', 'halt_stop.ogg', 11),
	(15, 'Kette ab', 'kette.ogg', 2),
	(16, 'yep yep', 'yepyep.ogg', 2),
	(17, 'to my hand', 'talk2thehand.ogg', 11),
	(18, 'failed', 'fail.ogg', 11),
	(19, 'I dont speak spanish!', 'dontspeakspanish.ogg', 2),
	(20, 'guten morgen...', 'guten_morgen.ogg', 2),
	(21, 'cindy ringtone', 'cancan.ogg', 2),
	(22, 'ralph', 'ente.ogg', 2),
	(23, 'aufs klo', 'gutenmorgenmaenner.ogg', 2),
	(24, 'wunderschön', 'wunderschoen.ogg', 2),
	(25, 'blbblblblbbb', 'toungesound.ogg', 2),
	(26, 'du bist böse!', 'bad_remulan.ogg', 10),
	(27, 'hau ab', 'rambo/hau_ab.ogg', 10),
	(28, 'angst!', 'rambo/angst.ogg', 10),
	(29, 'nur eier machen', 'rambo/eier_braten.ogg', 10),
	(30, 'keine eier!', 'rambo/keine_eier.ogg', 10),
	(31, 'mache eier!', 'rambo/mach_eier.ogg', 10),
	(32, 'bild fort', 'rambo/bild_fort.ogg', 10),
	(33, 'olé', 'rambo/lachscarpaccio.ogg', 10),
	(34, 'ich bin bauchredner', 'rambo/bauchredner.ogg', 10),
	(35, 'FATAAAL!', 'fataaal.ogg', 9),
	(36, 'Du Klauschwein!', 'gollum/du_klauschwein.ogg', 7),
	(37, 'Komm nie wieder', 'gollum/gollum_get_away.ogg', 7),
	(38, 'ich hör nicht zu', 'gollum/gollum_not_listen.ogg', 7),
	(39, 'das war ich!', 'gollum/gollum_was_me.ogg', 7),
	(40, 'deins', 'gollum/mache_de_augen_zu.ogg', 7),
	(41, 'nachm idioten gucken', 'gollum/nach_idioten_gucken.ogg', 7),
	(42, 'scheiße junge!', 'gollum/scheisse_junge.ogg', 7),
	(43, 'ihr schweine habt', 'gotye/ihr_habt_mich_angemalt.ogg', 2),
	(44, 'ich fand dich eigentlich ganz süß', 'gotye/ich_fand_dich_ganz_suess.ogg', 2),
	(45, 'dolphin', 'dolphinsound.ogg', 6),
	(46, 'krähhh', 'crowsound.ogg', 6),
	(47, 'blitzolli', 'timeforblitzkrieg.ogg', 2),
	(48, 'schnurrbart', 'vicky/denschnurrbartfaerben.OGG', 8),
	(49, 'fischladen', 'vicky/fischladen.OGG', 8),
	(50, 'jabaernein', 'vicky/jabaernein.OGG', 8),
	(51, 'kopfschmaerzen', 'vicky/kopfschmaerzen.OGG', 8),
	(52, 'nichtsgesagt', 'vicky/nichtsgesagt.OGG', 8),
	(53, 'wasdudaredest', 'vicky/wasdudaredest.OGG', 8),
	(54, 'essenkommen', 'essenkommen.ogg', 2),
	(55, 'have u tried?', 'itcrowd/turn_off_and_on.OGG', 5),
	(56, 'turn it on again!', 'itcrowd/turn_it_back_on_again.OGG', 5),
	(57, 'have u tried 2?', 'itcrowd/stick_it_up_the_arse.OGG', 5),
	(58, 'ans been pissen', 'frauentausch/an_been_pissen.OGG', 4),
	(59, 'fremde schuhe', 'frauentausch/fremde_schuhe.OGG', 4),
	(60, 'furchtbar, ich grieg det kotzen', 'frauentausch/furchtbar_ich_grieg_det_kotzen.OGG', 4),
	(61, 'hier geh ich nicht rein', 'frauentausch/hier_geh_ich_nicht_rein.OGG', 4),
	(62, 'schlecht1', 'frauentausch/mir_wird_jetzt_schon_schlecht.OGG', 4),
	(63, 'schlecht2', 'frauentausch/mir_wird_nur_schlecht_hier.OGG', 4),
	(64, 'saumaesig', 'frauentausch/saumaesig.OGG', 4),
	(65, 'unordentlicher mensch', 'frauentausch/unordentlicher_mensch.OGG', 4),
	(66, 'wie war das?', 'fatfighters/wie_war_das.OGG', 3),
	(67, 'frau löwe', 'fatfighters/frau_loewe.OGG', 3),
	(68, 'wer hat an der uhr gedreht?', 'schon_so_spaet.OGG', 2),
	(69, 'SUPPPORT, HELP!', 'flash1.ogg', 2),
	(70, 'Hirn geht nicht!!', 'brain_defect.ogg', 2),
	(71, '15khz', '15kHz_Frequenz.wav', 2),
	(72, 'kalter Wind', 'kalterwind.ogg', 2),
	(73, 'mario theme', 'mario/mario_main.OGG', 1),
	(74, 'bad', 'mario/mario_bad.OGG', 1),
	(75, 'levelup', 'mario/mario_levelup.OGG', 1),
	(76, 'fast', 'mario/mario_fast.OGG', 1),
	(77, 'blaues licht', 'rambo/blaues_licht.OGG', 10),
	(78, 'Ja klar...', 'deinemudda.OGG', 11),
	(79, 'Besser isses', 'hastnproblem.OGG', 11),
	(80, 'Käffchen?', 'coffe_1.OGG', 12),
	(81, 'Käffchen, Heinz?', 'coffe_heinz.OGG', 12);
/*!40000 ALTER TABLE `soundfiles` ENABLE KEYS */;


-- Dumping structure for table sound.sound_categories
...
-- Dumping data for table sound.sound_categories: ~12 rows (approximately)
/*!40000 ALTER TABLE `sound_categories` DISABLE KEYS */;
INSERT INTO `sound_categories` (`id`, `name`) VALUES
	(1, 'SuperMario'),
	(2, 'FunSound'),
	(3, 'LittleBritain'),
	(4, 'Frauentausch'),
	...
	(11, 'Blame'),
	(12, 'Daily');
/*!40000 ALTER TABLE `sound_categories` ENABLE KEYS */;


-- Dumping structure for table sound.users
...
-- Dumping data for table sound.users: 4 rows
...
INSERT INTO `users` (`id`, `username`, `password`, `temp_pass`, `temp_pass_active`, `first_name`, `last_name`, `email`, `dialing_code`, `phone`, `city`, `country`, `thumb_path`, `img_path`, `active`, `level_access`, `reg_date`, `last_active`) VALUES
	(15, 'fiete', 'd1ddc5d7dfb0f2e124c49ec6b618b241', '', 0, 'Jeder', 'Mann', '0', 0, 0, 'Omulu', 'Zimbabwe', 'pics/index_thumb.jpg', 'pics/index.jpg', 1, 2, '0000-00-00', ''),
	(4, 'Daniel', '642e6da810650a7646cd8c3951adcd04', '', 0, 'Daniel', 'Mikus', '0', 0, 0, 'Berlin', 'Germany', 'pics/2382daniel2_thumb.jpg', 'pics/2382daniel2.jpg', 1, 2, '0000-00-00', ''),
	(14, 'andre', '758dc7aa84df6edf406a36ca5db19d82', '', 0, '', '', '', 0, 0, '', '', '', '', 1, 2, '0000-00-00', ''),
	(13, 'enrico', 'efc6d3f2d4bcaa5314f255bb3ba4fdaa', '', 0, 'Weihnachts', 'Mann', '0', 0, 0, 'Ouagadougou', 'Burkina Faso', 'pics/2705starker_hund_thumb.jpg', 'pics/2705starker_hund.jpg', 1, 2, '0000-00-00', '');
